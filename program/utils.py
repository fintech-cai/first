...
def copy_Files(destination, data_type):
    ...
    copy("flow.py", os.path.join(destination_dir, "flow.py"))
    copy("traineres/trainer.py", os.path.join(destination_dir, "trainer.py"))
    ...
    copy("models/ts_tcc_loss.py", os.path.join(destination_dir, "ts_tcc_loss.py"))
